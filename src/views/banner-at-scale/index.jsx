...
const BannersAtScale = ({onContextChange}) => {
        ...
        <div className='hero-banner' style={{
            ...
            <Flex direction={'column'} height={'100%'} width={'100%'} alignItems={'center'}>
                <Flex direction={'row'} height={'100%'} alignItems={'center'}>
                    <Heading level={1}>Banner At Scale</Heading>
                </Flex>
                <View marginBottom={'-30px'} width={'80%'}>
                    <SmartPrompt destination = "/banner-at-scale/setup" onContextChange={(payload) => handlePayloadUpdate(payload)}/>
                </View>
            </Flex>
        </div>
