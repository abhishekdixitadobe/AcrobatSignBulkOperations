...
const SocialPost = ({onContextChange}) => {
        ...
        <div className='hero-banner' style={{
            ...
            <Flex direction={'column'} height={'100%'} width={'100%'} alignItems={'center'}>
                <Flex direction={'row'} height={'100%'} alignItems={'center'}>
                    <Heading level={1}>Social Media Post</Heading>
                </Flex>
                <View marginBottom={'-30px'} width={'80%'}>
                    <SmartPrompt destination = '/social-post/setup' onContextChange={(payload) => handlePayloadUpdate(payload)}/>
                </View>
            </Flex>
        </div>
